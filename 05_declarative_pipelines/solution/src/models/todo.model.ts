...
export const mapTodoEntityCollection = (todos: TodoEntity[]): TodoModel[] =>
  todos.map(mapTodoEntity);
...
export const mapTodoModelCollection = (todos: TodoModel[]): TodoEntity[] =>
  todos.map(mapTodoModel);
