...
Aunque parezca increible, los contenedores y sus precursores llevan por aquí más de 17 años, en los sistemas operativos de Linux y Unix. Desde comienzos del 2000, ha habido intentos para encapsular la tecnología de contenedores para el usuario final:
...
Los contenedores usan las tecnologías anteriormente citadas para crear imágenes ligeras, que actúan de manera independiente, encapsulando completamente un trozo de software que lleva todo lo que necesita dentro de su propia caja. Esto puede incluir los binarios de una aplicación, cualquier herramienta del sistema o librerías, configuración basada en el entorno de ejecución, y las intrucciones necesarias para su ejecución. 
