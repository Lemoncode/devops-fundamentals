...
1. We have added a new variable `CANARY_DEPLOYMENT`, to make this vlaue truthy, the user must start the pipeline and set the value.
2. The canary stage only runs if the branch is production.
3. We have done a little refatcor to make the code cleaner.